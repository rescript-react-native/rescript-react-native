...
function sections(reSections) {
  return $$Array.map((function (reSection) {
                return {
                        ...
                        renderItem: Js_undefined.fromOption(UtilsRN$Rebolt.option_map(renderItem, reSection[/* renderItem */2]))
                      };
              }), reSections);
}
...
function separatorComponent(reSeparatorComponent, jsSeparatorProps) {
  return Curry._1(reSeparatorComponent, /* record */[
              ...
              /* leadingSection */UtilsRN$Rebolt.option_map(jsSectionToSection, Js_primitive.undefined_to_opt(jsSeparatorProps.leadingSection)),
              ...
              /* trailingSection */UtilsRN$Rebolt.option_map(jsSectionToSection, Js_primitive.undefined_to_opt(jsSeparatorProps.trailingSection))
            ]);
}
...
function make(sections, renderItem, keyExtractor, itemSeparatorComponent, listEmptyComponent, listFooterComponent, listHeaderComponent, sectionSeparatorComponent, inverted, extraData, initialNumToRender, onEndReached, onEndReachedThreshold, onViewableItemsChanged, onRefresh, refreshing, renderSectionHeader, renderSectionFooter, stickySectionHeadersEnabled, keyboardDismissMode, keyboardShouldPersistTaps, showsHorizontalScrollIndicator, showsVerticalScrollIndicator, getItemLayout, _children) {
  return ReasonReact.wrapJsForReason(ReactNative.SectionList, {
              ...
              stickySectionHeadersEnabled: Js_undefined.fromOption(UtilsRN$Rebolt.optBoolToOptJsBoolean(stickySectionHeadersEnabled)),
              keyboardDismissMode: Js_undefined.fromOption(UtilsRN$Rebolt.option_map(keyboardDismissModeToJs, keyboardDismissMode)),
              keyboardShouldPersistTaps: Js_undefined.fromOption(UtilsRN$Rebolt.option_map(keyboardShouldPersistTapsToJs, keyboardShouldPersistTaps)),
