...
function separatorComponent(reSeparatorComponent, jsSeparatorProps) {
  return Curry._1(reSeparatorComponent, /* record */[
              ...
              /* leadingSection */Belt_Option.map(Js_primitive.undefined_to_opt(jsSeparatorProps.leadingSection), jsSectionToSection),
              ...
              /* trailingSection */Belt_Option.map(Js_primitive.undefined_to_opt(jsSeparatorProps.trailingSection), jsSectionToSection)
            ]);
}
