...
function CreateComponent(Impl) {
  var make = function (accessible, allowFontScaling, ellipsizeMode, numberOfLines, onLayout, onLongPress, onPress, pressRetentionOffset, selectable, style, testID, selectionColor, textBreakStrategy, adjustsFontSizeToFit, minimumFontScale, suppressHighlighting, value, children) {
    return ReasonReact.wrapJsForReason(Impl[/* view */0], {
                ...
                allowFontScaling: Js_undefined.fromOption(UtilsRN$Rebolt.optBoolToOptJsBoolean(allowFontScaling)),
                ellipsizeMode: Js_undefined.fromOption(UtilsRN$Rebolt.option_map((function (param) {
                            if (param >= -866200747) {
                              if (param >= -856246640) {
                                return "tail";
                              } else {
                ...
                selectable: Js_undefined.fromOption(UtilsRN$Rebolt.optBoolToOptJsBoolean(selectable)),
                ...
                textBreakStrategy: Js_undefined.fromOption(UtilsRN$Rebolt.option_map((function (param) {
                            if (param !== -128197688) {
                              if (param >= 947848242) {
                                return "simple";
                              } else {
                ...
                adjustsFontSizeToFit: Js_undefined.fromOption(UtilsRN$Rebolt.optBoolToOptJsBoolean(adjustsFontSizeToFit)),
                minimumFontScale: Js_undefined.fromOption(minimumFontScale),
                suppressHighlighting: Js_undefined.fromOption(UtilsRN$Rebolt.optBoolToOptJsBoolean(suppressHighlighting))
