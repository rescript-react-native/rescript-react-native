...
function make(accessible, accessibilityComponentType, accessibilityTraits, delayLongPress, delayPressIn, delayPressOut, disabled, hitSlop, style, onLayout, onPress, onPressIn, onPressOut, pressRetentionOffset, activeOpacity, focusedOpacity, tvParallaxProperties) {
  var partial_arg = {
