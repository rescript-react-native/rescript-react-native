...
function CreateComponent(Impl) {
  ...
  var make = function (onError, onLayout, onLoad, onLoadEnd, onLoadStart, resizeMode, source, style, testID, resizeMethod, accessibilityLabel, accessible, blurRadius, capInsets, defaultSource, onPartialLoad, onProgress) {
    var partial_arg = {
      ...
      resizeMode: Js_undefined.from_opt(UtilsRN$BsReactNative.option_map(encodeResizeMode, resizeMode)),
      source: Js_undefined.from_opt(UtilsRN$BsReactNative.option_map(encodeSource, source)),
      style: Js_undefined.from_opt(style),
      testID: Js_undefined.from_opt(testID),
      resizeMethod: Js_undefined.from_opt(UtilsRN$BsReactNative.option_map(encodeResizeMethod, resizeMethod)),
      ...
      defaultSource: Js_undefined.from_opt(UtilsRN$BsReactNative.option_map(encodeDefaultSource, defaultSource)),
