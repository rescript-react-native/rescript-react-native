...
function navigationTypeToJs(param) {
  return Js_mapperRt.binarySearch(6, param, jsMapperConstantArray);
}

function navigationTypeFromJs(param) {
...
exports.navigationTypeToJs = navigationTypeToJs;
exports.navigationTypeFromJs = navigationTypeFromJs;
