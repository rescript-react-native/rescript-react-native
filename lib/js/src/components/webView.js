...
function optionalCallbackToJs(callbackFunction) {
  return Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (callback, params) {
                    return Curry._1(callback, {
                                ...
                                loading: UtilsRN$BsReactNative.option_map((function (prim) {
                                        return +prim;
                                      }), Js_primitive.null_undefined_to_opt(params.loading)),
                                canGoBack: UtilsRN$BsReactNative.option_map((function (prim) {
                                        return +prim;
                                      }), Js_primitive.null_undefined_to_opt(params.canGoBack)),
                                canGoForward: UtilsRN$BsReactNative.option_map((function (prim) {
                                        return +prim;
                                      }), Js_primitive.null_undefined_to_opt(params.canGoForward))
                              });
                  }), callbackFunction));
}
