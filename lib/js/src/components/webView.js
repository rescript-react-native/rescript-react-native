...
function contentInsets(prim, prim$1, prim$2, prim$3, _) {
  var tmp = { };
  if (prim !== undefined) {
    tmp.top = Js_primitive.valFromOption(prim);
  }
  if (prim$1 !== undefined) {
    tmp.left = Js_primitive.valFromOption(prim$1);
  }
  if (prim$2 !== undefined) {
    tmp.bottom = Js_primitive.valFromOption(prim$2);
  }
  if (prim$3 !== undefined) {
    tmp.right = Js_primitive.valFromOption(prim$3);
  }
  return tmp;
}
