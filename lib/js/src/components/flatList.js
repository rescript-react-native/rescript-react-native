...
function make(data, renderItem, keyExtractor, itemSeparatorComponent, bounces, listFooterComponent, listHeaderComponent, columnWrapperStyle, extraData, getItemLayout, horizontal, initialNumToRender, initialScrollIndex, inverted, numColumns, onEndReached, onEndReachedThreshold, onRefresh, onViewableItemsChanged, overScrollMode, pagingEnabled, refreshing, removeClippedSubviews, scrollEnabled, showsHorizontalScrollIndicator, showsVerticalScrollIndicator, windowSize, maxToRenderPerBatch, viewabilityConfig, onScroll, style, onLayout) {
  var partial_arg = Props$Rebolt.extendView(undefined, undefined, undefined, undefined, onLayout, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, {
        ...
        getItemLayout: Js_undefined.fromOption(UtilsRN$Rebolt.option_map((function (f, data, index) {
        ...
        inverted: Js_undefined.fromOption(UtilsRN$Rebolt.optBoolToOptJsBoolean(inverted)),
        ...
        refreshing: Js_undefined.fromOption(UtilsRN$Rebolt.optBoolToOptJsBoolean(refreshing)),
