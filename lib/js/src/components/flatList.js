...
function CreateComponent(Impl) {
  ...
  var make = function (data, renderItem, keyExtractor, itemSeparatorComponent, bounces, listFooterComponent, listHeaderComponent, listEmptyComponent, columnWrapperStyle, extraData, getItemLayout, horizontal, initialNumToRender, initialScrollIndex, inverted, numColumns, onEndReached, onEndReachedThreshold, onRefresh, onViewableItemsChanged, overScrollMode, pagingEnabled, refreshControl, refreshing, removeClippedSubviews, scrollEnabled, stickyHeaderIndices, showsHorizontalScrollIndicator, showsVerticalScrollIndicator, windowSize, maxToRenderPerBatch, viewabilityConfig, scrollEventThrottle, onScroll, onScrollBeginDrag, onScrollEndDrag, onMomentumScrollBegin, onMomentumScrollEnd, style, contentInsetAdjustmentBehavior) {
    var partial_arg = {
      bounces: bounces,
