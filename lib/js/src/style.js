...
var Encode$Rebolt = require("./private/encode.js");
var UtilsRN$Rebolt = require("./private/utilsRN.js");

function encode_pt_pct(param) {
  if (param.tag) {
    return Encode$Rebolt.pct(param[0]);
  } else {
    return param[0];
  }
}
...
function encode_pt_pct_auto(value) {
  if (typeof value === "number") {
    ...
    return Encode$Rebolt.pct(value[0]);
  } else {
    return value[0];
  }
}
...
function combine(a, b) {
  return UtilsRN$Rebolt.dictFromArray($$Array.append(UtilsRN$Rebolt.dictEntries(a), UtilsRN$Rebolt.dictEntries(b)));
}

var concat = $$Array.of_list;

var style = UtilsRN$Rebolt.dictFromList;
...
function shadowOffset(height, width) {
  return /* tuple */[
          "shadowOffset",
          UtilsRN$Rebolt.dictFromArray(/* array */[
                /* tuple */[
                  "height",
                  height
                ],
...
function create_(encoder, rotationEncoder, perspective, rotate, rotateX, rotateY, rotateZ, scaleX, scaleY, translateX, translateY, skewX, skewY) {
  ...
  var values = $$Array.fold_right((function (x, acc) {
          var match = x[1];
          if (match !== undefined) {
            var val_ = UtilsRN$Rebolt.dictFromArray(/* array */[/* tuple */[
                    x[0],
...
function make(perspective, rotate, rotateX, rotateY, rotateZ, scaleX, scaleY, translateX, translateY, skewX, skewY, _) {
  return create_((function (value) {
                return UtilsRN$Rebolt.option_map((function (prim) {
                              return prim;
                            }), value);
              }), (function (value) {
                return UtilsRN$Rebolt.option_map((function (prim) {
