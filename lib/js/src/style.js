...
function create_(encoder, rotationEncoder, perspective, rotate, rotateX, rotateY, rotateZ, scaleX, scaleY, translateX, translateY, skewX, skewY) {
  var opt_values_000 = /* tuple */[
    "perspective",
    Curry._1(encoder, perspective)
  ];
  var opt_values_001 = /* :: */[
    /* tuple */[
      "rotate",
      Curry._1(rotationEncoder, rotate)
    ],
    /* :: */[
      /* tuple */[
        "rotateX",
        Curry._1(rotationEncoder, rotateX)
      ],
      /* :: */[
        /* tuple */[
          "rotateY",
          Curry._1(rotationEncoder, rotateY)
        ],
        /* :: */[
          /* tuple */[
            "rotateZ",
            Curry._1(rotationEncoder, rotateZ)
          ],
          /* :: */[
            /* tuple */[
              "scaleX",
              Curry._1(encoder, scaleX)
            ],
            /* :: */[
              /* tuple */[
                "scaleY",
                Curry._1(encoder, scaleY)
              ],
              /* :: */[
                /* tuple */[
                  "translateX",
                  Curry._1(encoder, translateX)
                ],
                /* :: */[
                  /* tuple */[
                    "translateY",
                    Curry._1(encoder, translateY)
                  ],
                  /* :: */[
                    /* tuple */[
                      "skewX",
                      Curry._1(encoder, skewX)
                    ],
                    /* :: */[
                      /* tuple */[
                        "skewY",
                        Curry._1(encoder, skewY)
                      ],
                      /* [] */0
                    ]
                  ]
