...
function interpolate(value, inputRange, outputRange, easing, extrapolate, extrapolateLeft, extrapolateRight, _) {
  ...
  var tmp$1 = UtilsRN$Rebolt.option_map(extrapolateString, extrapolate);
  if (tmp$1 !== undefined) {
    tmp.extrapolate = Js_primitive.valFromOption(tmp$1);
  }
  var tmp$2 = UtilsRN$Rebolt.option_map(extrapolateString, extrapolateLeft);
  if (tmp$2 !== undefined) {
    tmp.extrapolateLeft = Js_primitive.valFromOption(tmp$2);
  }
  var tmp$3 = UtilsRN$Rebolt.option_map(extrapolateString, extrapolateRight);
  if (tmp$3 !== undefined) {
...
function animate(value, velocity, deceleration, isInteraction, useNativeDriver, onComplete, iterations, _) {
  ...
  var tmp$1 = UtilsRN$Rebolt.optBoolToOptJsBoolean(isInteraction);
  if (tmp$1 !== undefined) {
    tmp.isInteraction = Js_primitive.valFromOption(tmp$1);
  }
  var tmp$2 = UtilsRN$Rebolt.optBoolToOptJsBoolean(useNativeDriver);
  if (tmp$2 !== undefined) {
...
function Value_019(prim, prim$1) {
  return ReactNative.Animated.multiply(prim, prim$1);
}

function Value_020(prim, prim$1) {
  return ReactNative.Animated.modulo(prim, prim$1);
}

function Value_021(prim, prim$1, prim$2) {
