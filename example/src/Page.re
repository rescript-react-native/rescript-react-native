...
let styles =
  StyleSheet.create {
    "button":
      style marginTop::50 height::50 width::100 borderBottomWidth::StyleSheet.hairlineWidth (),
...
module Page = {
  ...
  let render {props, updater} => {
    ...
    <View style=styles##container>
      <Text ellipsizeMode=`middle style=styles##inner> (ReactRe.stringToElement "hello!") </Text>
      <View style=styles##innerView />
      <Button style=styles##button title="Learn More" onPress=(updater handleClick) />
    </View>
  };
};
