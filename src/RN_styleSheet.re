...
[@bs.get] external absoluteFill: t => RN_style.t = "absoluteFill";

let absoluteFill = absoluteFill(t);

[@bs.get] external absoluteFillObject: t => RN_style.t = "absoluteFillObject";

let absoluteFillObject = absoluteFillObject(t);

[@bs.send] external flatten: (t, array(RN_style.t)) => RN_style.t = "flatten";
