...
external styleObj: styleObj => t = "%identity"
...
// - shadow style
// - layout style
@obj @deprecated("Use styleObj instead")
external style: (
  // Image Style Props (https://reactnative.dev/docs/image-style-props)
  ~resizeMode: resizeMode=?,
  ~overlayColor: Color.t=?,
...
external viewStyleObj: viewStyleObj => t = "%identity"

// ____ViewStyleProp_Internal
@obj @deprecated("Use viewStyleObj instead")
external viewStyle: (
  // View styles https://reactnative.dev/docs/view-style-props
  ~backfaceVisibility: backfaceVisibility=?,
  ~backgroundColor: Color.t=?,
...
external textStyleObj: textStyleObj => t = "%identity"

// ____TextStyleProp_Internal
@obj @deprecated("Use textStyleObj instead")
external textStyle: (
  // Text Style Props (https://reactnative.dev/docs/text-style-props)
  ~color: Color.t=?,
  ~fontFamily: string=?,
...
external imageStyleObj: imageStyleObj => t = "%identity"

// ____ImageStyleProp_Internal
@obj @deprecated("Use imageStyleObj instead")
external imageStyle: (
  // Image Style Props (https://reactnative.dev/docs/image-style-props)
  ~resizeMode: resizeMode=?,
  ~overlayColor: Color.t=?,
