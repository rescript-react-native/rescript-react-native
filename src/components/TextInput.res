...
type dataDetectorType = [#phoneNumber | #link | #address | #calendarEvent | #none | #all]

type importantForAutofill = [#auto | #no | #noExcludeDescendants | #yes | #yesExcludeDescendants]
...
external make: (
  ...
  [
    ...
    | #url
    | @bs.as("name-phone-pad")
    #namePhonePad
    | #twitter
    | @bs.as("web-search")
    #webSearch
    | @bs.as("visible-password")
    #visiblePassword
  ]=?,
