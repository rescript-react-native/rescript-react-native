...
let make =
    (
      ...
      ~maximumTrackImage: option(RN_image.imageSource)=?,
      ~minimumTrackImage: option(RN_image.imageSource)=?,
      ~thumbImage: option(RN_image.imageSource)=?,
      ~trackImage: option(RN_image.imageSource)=?,
      ~accessibilityLabel=?,
      ~accessible=?,
      ~hitSlop=?,
      ~onAccessibilityTap=?,
